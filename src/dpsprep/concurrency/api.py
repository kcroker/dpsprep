...
from .processor import SubprocessPageProcessor
...
def concurrently_process_pages(options: DpsPrepOptions, document: djvu.decode.Document) -> None:
    ...
    proc = SubprocessPageProcessor(options, document)
    proc.process()
