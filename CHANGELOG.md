...
* Include the fixtures in the source distribution.

## 2.8.0 - 2026-07-05

* Publish wheels to PyPI.
* Implement an in-tree build backend for doc generation.
...
* Use the Rich logging handler.
* Migrate to stdlib logging.
